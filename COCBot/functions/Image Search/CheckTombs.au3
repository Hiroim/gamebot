...
; Modified ......: sardo 2015-06 2015-08 z0mbie 2015-08
...
Func CheckTombs()
	...
	SetLog(getLocaleString("logClearTombs"), $COLOR_BLUE)
	...
	If IsArray($res) Then
		...
		If $res[0] = "0" Then
				...
				SetLog(getLocaleString("logNoTombsFound"), $COLOR_RED)
		ElseIf $res[0] = "-1" Then
				SetLog("DLL Error", $COLOR_RED)
		ElseIf $res[0] = "-2" Then
				SetLog(getLocaleString("logInvalidResolution"), $COLOR_RED)
		Else
			...
			For $j = 1 To UBound($expRet) - 1 Step 2
				...
				If isInsideDiamondXY($TombX, $TombY) Then
					SetLog(getLocaleString("logTombsFound") & $TombX & "," & $TombY &")", $COLOR_GREEN)
