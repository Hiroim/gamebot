...
$tabTroops = GUICtrlCreateTabItem(getLocaleString("tabTroops"))
	...
	$grpTroops = GUICtrlCreateGroup(getLocaleString("grpTroops"), $x - 20, $y - 20, 222, 115)
		...
		$lblBarbarians = GUICtrlCreateLabel(getLocaleString("troopBarbarians"), $x + 25, $y, -1, -1)
		...
		$lblArchers = GUICtrlCreateLabel(getLocaleString("troopArchers"), $x + 25, $y, -1, -1)
		...
		$lblGoblins = GUICtrlCreateLabel(getLocaleString("troopGoblins"), $x + 25, $y, -1, -1)
