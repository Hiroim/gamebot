...
Local $x = 30, $y = 150
	$Laboratory = GUICtrlCreateGroup(getLocaleString("lblLaboratory"), $x - 20, $y - 20, 450, 65)
		...
		$lblNextUpgrade = GUICtrlCreateLabel(getLocaleString("lblNextUpgrade"), $x + 215, $y + 12, -1, -1)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$cmbLaboratory = GUICtrlCreateCombo("", $x + 275, $y + 8, 125, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
