...
$grpOnStartBot = GUICtrlCreateGroup(getLocaleString("grpOnStartBot"), $x - 20, $y - 20, 205, 115)
	...
	$txtWAOffsetx = GUICtrlCreateInput("10", $x + 120, $y, 25, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
        GUICtrlSetTip(-1, getLocaleString("tipOffsetX"))
		GUICtrlSetLimit(-1, 2)
	$txtWAOffsety= GUICtrlCreateInput("10", $x + 150, $y, 25, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
		GUICtrlSetTip(-1, getLocaleString("tipOffsetY"))
		GUICtrlSetLimit(-1, 2)
	$y += 23
