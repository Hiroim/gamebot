...
#ce			GUICtrlSetTip(-1, getLocaleString("tipBtnSearchMode"))
	...
	$grpDeadBaseConditions = GUICtrlCreateGroup(getLocaleString("grpDeadBaseConditions"), $x - 20, $y - 20, 225, 255)
		...
		$txtDBEnableAfter = GUICtrlCreateInput("150", $x + 80, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetState(-1, $GUI_HIDE)
		$lblDBEnableAfter = GUICtrlCreateLabel(getLocaleString("lblSearches",1), $x + 135, $y - 4, -1, -1)
			GUICtrlSetTip(-1, getLocaleString("tipEnableAfterSearches"))
			GUICtrlSetState(-1, $GUI_HIDE)
		$y += 21
		$cmbDBMeetGE = GUICtrlCreateCombo("", $x , $y + 10, 65, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetTip(-1, getLocaleString("tipCmbMeetGE",1), getLocaleString("tipCmbMeetGETitle",1))
	...
	$grpLiveBaseConditions = GUICtrlCreateGroup(getLocaleString("grpLiveBaseConditions"), $x - 20, $y - 20, 220, 255)
		...
		$txtABEnableAfter = GUICtrlCreateInput("150", $x + 80, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			_GUICtrlEdit_SetReadOnly(-1, True)
			GUICtrlSetState(-1, $GUI_HIDE)
		$lblABEnableAfter = GUICtrlCreateLabel(getLocaleString("lblSearches",1), $x + 135, $y - 4, -1, -1)
			GUICtrlSetTip(-1, getLocaleString("tipEnableAfterSearches"))
			GUICtrlSetState(-1, $GUI_HIDE)
		$y += 21
		$cmbABMeetGE = GUICtrlCreateCombo("", $x , $y + 10, 65, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			GUICtrlSetData(-1, getLocaleString("cmbLBMeetGE"), getLocaleString("cmbLBMeetGEDefault"))
			GUICtrlSetTip(-1, getLocaleString("tipCmbMeetGE"), getLocaleString("tipCmbMeetGETitle"))
	...
	$grpSearchReduction = GUICtrlCreateGroup(getLocaleString("grpSearchReduction"), $x - 20, $y - 20, 450, 55)
		...
		$txtSearchReduceCount = GUICtrlCreateInput("20", $x + 105, $y + 2, 35, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 3)
		$lblSearchReduceCount = GUICtrlCreateLabel(getLocaleString("lblSearches",1), $x + 148, $y - 4, -1, -1)
		$x += 210
		$y -= 9
